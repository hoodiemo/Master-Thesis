...
%load data
Y1 = xlsread('indonesia_1871_2020.xlsx');
...
D =[     0    0.2000 %sigmag
   ...
   -0.9900    0.9900 %rhomu
         ...
         0    10.0000%pssi
         0    5.0000 %eta
    0.0001    0.0103 %stdmey
    0.0001    0.0144 %stdmec
    0.0001    0.0586 %stdmeiv
    0.0001    0.0097 %stdmetby
    ];
...
%The following two variables initialize the computation of the posterior mean and variance of the vector of estimated parameters
mean_param = 0;
var_param = 0;
accept_rate = 0;
...
%mean_param, std_param and var_param report moments of the estimated
