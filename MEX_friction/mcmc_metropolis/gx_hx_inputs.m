...
% evaluates at the deterministic steady state the equlibrium conditioins, nf, 
% first derivatives, nfx, nfy, nfxp, nfyp,  and variance matrices, 
% nvarshock \equiv nETASHOCK*nETASHOCK' of innovations associated with a DSGE model. 
% The variance matrix of measurement errors varme is also evaluated. 
%
...
tby = 0.0088; %trade balance to output ratio 
