...
disp("done with running bayes1.m for the first time")
...
bayes
disp('done with running bayes.m for the first time')
...
bayes1(std_param0,param0,k,LB,UB);
disp('done with running bayes1.m for the second time')
load bayes1 mean_k mean_param 
k= mean_k;
if exist('k.xls')
    !del k.xls
...
bayes
disp('done with running bayes.m for the second time.')
param0 = mean_param;
if exist('param0.xls')
    !del param0.xls
end
