...
%M: format compact suppresses extra blank lines
...
%Initial variance of stand-in normal density
...
%Vector collecting record of reason for rejection of draw: 0=no equilibrium, 1=draw rejected; 2=multiple equilibriu; 3=invertibility violated; 4=bound violated; 5=draw accepted
exitflag_chain = zeros(ndraw,1);
...
for j=1:ndraw
    ...
    %Make sure the draw is within bounds, hence exitflag sets default to 4
    %(bound violation)
    ...
    %add current iteration values to vector
