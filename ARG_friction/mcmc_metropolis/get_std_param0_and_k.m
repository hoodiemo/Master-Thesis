...
%Elements D(14:17,2) were obtained as std(Y)'*0.25;  
%This implies that the upper bound of the prior distribution of the 
%standard deviation of measurement errors is 25 percent of the standard
%deviation of the observables.  Equivalently, measurement errors are
%allowed to explain at most 6.25 percent of the variance of the observable. 
...
%initial standard deviation of stand-in distribution
std_param0 = eye(np); 
